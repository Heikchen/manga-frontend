...
<h2 className="uppercase font-bold text-3xl text-primary-white-color ml-3 p-1">Mangas</h2>
</div>
<div className="h-72"></div>
<div className="h-12 bg-primary-red-color ">
<h2 className="uppercase font-bold text-3xl text-primary-white-color ml-3 p-1">Animes</h2>
</div>
