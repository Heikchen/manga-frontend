...
{recommendations.map((recommendationsObject:any)=>(<Link to={`/anime/${recommendationsObject.node.id}`}><div className="flex flex-col shrink-0 items-center  justify-center w-72 h-80">
