...
function TopManga(){
    ...
    const fetchMangas =():void => {
        setLoading(true);
        axios.get(`https://manga-backend-server.herokuapp.com/manga/ranking?ranking_type=all&limit=10&offset=${offset}`, {
            headers: {
